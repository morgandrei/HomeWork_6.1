...
<main>
    ...
    <div class="container">
        ...
        <main class="row">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="mb-3">
                                    ...
                                    <input name="name" type="text" class="form-control" id="name" placeholder="Имя" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 class="display-6 fw-normal text-body-emphasis">F.A.Q.</h1>
                <p class="fs-5 text-body-secondary">нажав на кнопки ниже, вы узнаете ответы на наиболее частые вопросы.</p>
            </div>

                <p class="d-inline-flex gap-3 col">
                    ...
                    <button class="btn btn-primary form-control" type="button" data-bs-toggle="collapse" data-bs-target=".multi-collapse" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">Переключить все поля</button>
                </p>
